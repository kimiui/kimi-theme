...
export function OverviewFileView() {
  ...
  const [upload, { setTrue: setUploadTrue, setFalse: setUploadFalse }] = useBoolean();

  const [newFolder, { setTrue: setNewFolderTrue, setFalse: setNewFolderFalse }] = useBoolean();
  ...
  return (
    <>
        ...
        <Grid container spacing={3}>
          ...
          >
            <FileWidget
              ...
              value={GB / 10}
              total={GB}
              icon={<Iconify icon="logos:dropbox" sx={{ width: 48, height: 48 }} />}
            />
          </Grid>
          ...
          >
            <FileWidget
              ...
              value={GB / 5}
              total={GB}
              icon={<Iconify icon="logos:google-drive" sx={{ width: 48, height: 48 }} />}
            />
          </Grid>
          ...
          >
            <FileWidget
              ...
              value={GB / 2}
              total={GB}
              icon={<Iconify icon="logos:microsoft-onedrive" sx={{ width: 48, height: 48 }} />}
            />
          </Grid>
      ...
      <FileManagerNewFolderDialog open={upload} onClose={setUploadFalse} />
      <FileManagerNewFolderDialog
        open={newFolder}
        onClose={setNewFolderFalse}
        title="New Folder"
