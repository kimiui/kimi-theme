...
export function FileManagerFileDetails({
  ...
  const [toggleTags, toggleTagsActions] = useBoolean(true);

  const [share, shareActions] = useBoolean();

  const [properties, propertiesActions] = useBoolean(true);
  ...
  const renderTags = (
    <Stack spacing={1.5}>
      ...
      >
        Tags
        <IconButton size="small" onClick={toggleTagsActions.toggle}>
          <Iconify
            icon={toggleTags ? 'eva:arrow-ios-upward-fill' : 'eva:arrow-ios-downward-fill'}
          />
        </IconButton>
      </Stack>
  ...
  const renderProperties = (
    <Stack spacing={1.5}>
      ...
      >
        Properties
        <IconButton size="small" onClick={propertiesActions.toggle}>
          <Iconify
            icon={properties ? 'eva:arrow-ios-upward-fill' : 'eva:arrow-ios-downward-fill'}
          />
        </IconButton>
      </Stack>
