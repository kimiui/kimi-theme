...
export function KanbanDetails({
  ...
  const [like, likeActions] = useBoolean();

  const [contacts, contactsActions] = useBoolean();
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Box sx={{ gap: 1, display: 'flex', flexWrap: 'wrap' }}>
          ...
          <Tooltip title="Add assignee">
            <IconButton
              onClick={contactsActions.setTrue}
              sx={{
          ...
          <KanbanContactsDialog
            ...
            open={contacts}
            onClose={contactsActions.setFalse}
          />
        </Box>
      </Box>
