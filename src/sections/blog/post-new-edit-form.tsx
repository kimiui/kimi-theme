...
export function PostNewEditForm({ currentPost }: Readonly<Props>) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      reset();
      previewActions.setFalse();
      toast.success(currentPost ? 'Update success!' : 'Create success!');
      router.push(paths.dashboard.posts.root);
  ...
  const renderActions = (
    <Box display="flex" alignItems="center" flexWrap="wrap" justifyContent="flex-end">
      ...
      <div>
        <Button color="inherit" variant="outlined" size="large" onClick={previewActions.setTrue}>
          Preview
        </Button>
  ...
  return (
    <Form methods={methods} onSubmit={onSubmit}>
      ...
      <PostDetailsPreview
        ...
        onClose={previewActions.setFalse}
