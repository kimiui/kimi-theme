...
// ----------------------------------------------------------------------
export const Editor = forwardRef(({ sx, error, onChange, slotProps, helperText, resetValue, editable = true, fullItem = false, value: content = '', placeholder = 'Write something awesome...', ...other }, ref) => {
    ...
    return (_jsxs(Portal, { disablePortal: !fullScreen, children: [fullScreen && _jsx(Backdrop, { open: true, sx: { zIndex: (theme) => theme.zIndex.modal - 1 } }), _jsxs(Stack, { sx: {
                    ...(!editable && { cursor: 'not-allowed' }),
                    ...slotProps?.wrap,
                }, children: [_jsxs(StyledRoot, { error: !!error, disabled: !editable, fullScreen: fullScreen, className: editorClasses.root, sx: sx, children: [_jsx(Toolbar, { editor: editor, fullItem: fullItem, fullScreen: fullScreen, onToggleFullScreen: handleToggleFullScreen }), _jsx(EditorContent, { ref: ref, spellCheck: "false", autoComplete: "off", autoCapitalize: "off", editor: editor, className: editorClasses.content.root })] }), helperText && (_jsx(FormHelperText, { error: !!error, sx: { px: 2 }, children: helperText }))] })] }));
});
