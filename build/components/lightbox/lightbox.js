...
// ----------------------------------------------------------------------
export function Lightbox({ slides, disableZoom, disableVideo, disableTotal, disableCaptions, disableSlideshow, disableThumbnails, disableFullscreen, onGetCurrentIndex, ...other }) {
    ...
    return (_jsx(ReactLightbox, { slides: slides, animation: { swipe: 240 }, carousel: { finite: totalItems < 5 }, controller: { closeOnBackdropClick: true }, plugins: getPlugins({
        ...
        }, className: lightboxClasses.root, ...other }));
}
// ----------------------------------------------------------------------
