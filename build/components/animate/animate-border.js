...
export function AnimateBorder({ animate, sx }) {
    ...
    return (_jsxs(Box, { ref: rootRef, sx: {
            minWidth: 40,
            minHeight: 40,
            position: 'relative',
            ...
            ...sx,
        }, children: [_jsx(Box, { ref: animateRef, component: m.span, transition: transition, animate: !values.disable
                    ? {
                        background: background(typeof values.color === 'string' ? values.color : values.color[0]),
                    }
                    : undefined, sx: {
                    ...borderGradient({ padding: values.width }),
                } }), !values.disable && !values.disableDoubleline && (_jsx(Box, { component: m.span, transition: transition, animate: {
