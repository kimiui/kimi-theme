...
export const CarouselThumbs = forwardRef(({ children, slotProps, options, sx, ...other }, ref) => {
    ...
    return (_jsx(StyledRoot, { ref: ref, axis: axis, className: carouselClasses.thumbs, sx: {
            flexShrink: 0,
            ...(axis === 'x' && { p: 0.5, maxWidth: 1 }),
            ...(axis === 'y' && { p: 0.5, maxHeight: 1 }),
            ...(!slotProps?.disableMask && maskStyles),
            ...sx,
        }, ...other, children: _jsx(StyledContainer, { axis: axis, slideSpacing: slideSpacing, className: carouselClasses.thumbContainer, sx: {
                ...slotProps?.container,
            }, children: renderChildren }) }));
});
// ----------------------------------------------------------------------
export function CarouselThumb({ sx, src, index, selected, ...other }) {
    return (_jsx(ButtonBase, { className: carouselClasses.thumb, sx: {
            width: 64,
            height: 64,
            opacity: 0.48,
            flexShrink: 0,
            ...
            ...sx,
        }, ...other, children: _jsx(Box, { component: "img", alt: `carousel-thumb-${index}`, src: src, className: carouselClasses.thumbImage, sx: {
                width: 1,
                height: 1,
                objectFit: 'cover',
