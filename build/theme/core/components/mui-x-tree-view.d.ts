...
export declare const treeView: {
    MuiTreeItem: {
        ...
        styleOverrides?: Partial<import("@mui/material/styles/overrides").OverridesStyleRules<keyof import("@mui/x-tree-view/TreeItem").TreeItemClasses, "MuiTreeItem", Theme>> | undefined;
        variants?: {
