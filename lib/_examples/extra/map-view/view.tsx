...
import { cities as CITIES } from 'lib/_mock/_map/cities';
import { countries as COUNTRIES } from 'lib/_mock/_map/countries';
  ...
  return (
    <>
      <ComponentHero>
        <CustomBreadcrumbs
          heading="Map"
          links={[{ name: 'Components', href: paths.docs.components.root }, { name: 'Map' }]}
          moreLink={[
