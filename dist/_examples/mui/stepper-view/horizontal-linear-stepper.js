...
exports.HorizontalLinearStepper = HorizontalLinearStepper;
...
function HorizontalLinearStepper() {
    ...
    return ((0, jsx_runtime_1.jsxs)(Box_1.default, { sx: { width: 1 }, children: [(0, jsx_runtime_1.jsx)(Stepper_1.default, { activeStep: activeStep, children: steps.map(function (label, index) {
                    var stepProps = {};
                    var labelProps = {};
                    if (isStepOptional(index)) {
                        labelProps.optional = (0, jsx_runtime_1.jsx)(Typography_1.default, { variant: "caption", children: "Optional" });
                    }
