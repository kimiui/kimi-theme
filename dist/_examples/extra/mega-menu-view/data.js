...
export const navItems1 = [
    {
        title: 'Item 1',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:home-2-outline" }),
    ...
    },
    {
        title: 'Item 2',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:atom-outline" }),
        children: [
            { subheader: 'Other machinery & parts', items: arr_1 },
            { subheader: 'Plastic & woodworking', items: arr_2 },
            { subheader: 'Construction machinery', items: arr_3 },
    ...
    },
    {
        title: 'Item 3',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:chart-square-outline" }),
        info: _jsx(Label, { color: "info", children: "+3" }),
        children: [{ items: arr_1 }],
    },
    {
        title: 'Item 4',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:confetti-minimalistic-outline" }),
        info: '+72',
        children: [
            {
                items: [
    ...
    },
    {
        title: 'Item 5',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:gallery-circle-outline" }),
        children: [
            {
                items: [
                    { title: 'Foods', path: '#' },
    ...
    },
    {
        title: 'Item 6',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:hanger-2-outline" }),
        children: [
            {
                items: [
                    { title: 'Foods', path: '#' },
    ...
    },
    {
        title: 'Item 7',
        path: '#',
        icon: _jsx(Iconify, { icon: "solar:letter-outline" }),
        children: [
            {
                items: [
                    { title: 'Foods', path: '#' },
    ...
    },
    {
        ...
        icon: _jsx(Iconify, { icon: "solar:airbuds-case-open-outline" }),
        disabled: true,
    },
];
// ----------------------------------------------------------------------
