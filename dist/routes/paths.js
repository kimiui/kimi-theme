...
export const paths = {
    ...
    posts: {
        root: `/posts`,
        details: (title) => `/posts/${paramCase(title)}`,
    ...
    dashboard: {
        ...
        invoices: {
            ...
            details: (id) => `${ROOTS.DASHBOARD}/invoices/${id}`,
            edit: (id) => `${ROOTS.DASHBOARD}/invoices/${id}/edit`,
            demo: {
        ...
        posts: {
            ...
            details: (title) => `${ROOTS.DASHBOARD}/posts/${paramCase(title)}`,
            edit: (title) => `${ROOTS.DASHBOARD}/posts/${paramCase(title)}/edit`,
            demo: {
