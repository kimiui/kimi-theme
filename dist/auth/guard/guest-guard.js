...
function GuestGuard(_a) {
    ...
    var _c = (0, hooks_1.useAuthContext)(), loading = _c.loading, authenticated = _c.authenticated;
    var _d = (0, react_1.useState)(true), isChecking = _d[0], setIsChecking = _d[1];
    var returnTo = (_b = searchParams.get('returnTo')) !== null && _b !== void 0 ? _b : '/';
