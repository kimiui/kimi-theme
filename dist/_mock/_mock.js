...
import { _id, _ages, _roles, _prices, _emails, _ratings, _nativeS, _nativeM, _nativeL, _percents, _booleans, _sentences, _lastNames, _fullNames, _tourNames, _jobTitles, _taskNames, _fileNames, _postTitles, _firstNames, _eventNames, _courseNames, _fullAddress, _companyNames, _productNames, _descriptions, _phoneNumbers, _countryNames, } from './assets';
// ----------------------------------------------------------------------
export const _mock = {
    id: (index) => _id[index],
    ...
    // Image
    image: {
        cover: (index) => `/assets/images/cover/cover-${index + 1}.webp`,
        avatar: (index) => `/assets/images/avatar/avatar-${index + 1}.webp`,
        travel: (index) => `/assets/images/travel/travel-${index + 1}.webp`,
        course: (index) => `/assets/images/course/course-${index + 1}.webp`,
        company: (index) => `/assets/images/company/company-${index + 1}.webp`,
        product: (index) => `/assets/images/products/product-${index + 1}.webp`,
        portrait: (index) => `/assets/images/portrait/portrait-${index + 1}.webp`,
    },
    user: {
        ...
        phoneNumber: _phoneNumbers[1],
        country: _countryNames[1],
