...
export function NavToggleButton({ isNavMini, sx, ...other }) {
    return (_jsx(IconButton, { size: "small", sx: {
            ...
            ...sx,
        }, ...other, children: _jsx(SvgIcon, { sx: {
                width: 16,
                height: 16,
                ...(isNavMini && {
                    transform: 'scaleX(-1)',
                }),
            }, children: _jsx("path", { fill: "currentColor", d: "M13.83 19a1 1 0 0 1-.78-.37l-4.83-6a1 1 0 0 1 0-1.27l5-6a1 1 0 0 1 1.54 1.28L10.29 12l4.32 5.36a1 1 0 0 1-.78 1.64" }) }) }));
}
