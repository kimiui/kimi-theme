...
export function HeaderSection({ sx, slots, slotProps, disableOffset, disableElevation, layoutQuery = 'md', ...other }) {
    ...
    return (_jsxs(AppBar, { position: "sticky", className: layoutClasses.header, sx: appBarSx, ...other, children: [slots?.topArea, _jsx(Toolbar, { disableGutters: true, ...slotProps?.toolbar, sx: toolbarSx, children: _jsxs(Container, { ...slotProps?.container, sx: containerSx, children: [slots?.leftArea, _jsx(Box, { sx: boxSx, children: slots?.centerArea }), slots?.rightArea] }) }), slots?.bottomArea, !disableElevation && offsetTop && _jsx(StyledElevation, {})] }));
}
