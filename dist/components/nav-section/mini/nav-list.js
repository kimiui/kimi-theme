...
function NavList(_a) {
    ...
    // Has children
    if (data.children) {
        return ((0, jsx_runtime_1.jsxs)(styles_3.NavLi, { disabled: data.disabled, children: [renderNavItem, (0, jsx_runtime_1.jsx)(Popover_1.default, { disableScrollLock: true, open: openMenu, anchorEl: navItemRef.current, anchorOrigin: { vertical: 'center', horizontal: 'right' }, transformOrigin: { vertical: 'center', horizontal: 'left' }, slotProps: {
                        paper: {
                            onMouseEnter: handleOpenMenu,
                            onMouseLeave: handleCloseMenu,
                            sx: __assign(__assign({ px: 0.75, boxShadow: 'none', overflow: 'unset', backdropFilter: 'none', background: 'transparent' }, (depth > 1 && { mt: -1 })), (openMenu && { pointerEvents: 'auto' })),
                        },
...
function NavSubList(_a) {
    var data = _a.data, render = _a.render, depth = _a.depth, slotProps = _a.slotProps, enabledRootRedirect = _a.enabledRootRedirect, cssVars = _a.cssVars;
