...
var StyledNavItem = (0, styles_1.styled)(ButtonBase_1.default, {
    ...
    return __assign(__assign(__assign({}, (rootItem && __assign(__assign(__assign(__assign({}, baseStyles.item), (_b = { padding: 'var(--nav-item-root-padding)', minHeight: 'var(--nav-item-root-height)' }, _b["& .".concat(classes_1.navSectionClasses.item.icon)] = __assign(__assign({}, baseStyles.icon), { margin: 'var(--nav-icon-root-margin)' }), _b["& .".concat(classes_1.navSectionClasses.item.title)] = __assign(__assign({}, baseStyles.title), { whiteSpace: 'nowrap' }), _b["& .".concat(classes_1.navSectionClasses.item.caption)] = __assign(__assign({}, baseStyles.caption), { marginLeft: theme.spacing(0.75) }), _b["& .".concat(classes_1.navSectionClasses.item.arrow)] = __assign({}, baseStyles.arrow), _b["& .".concat(classes_1.navSectionClasses.item.info)] = __assign({}, baseStyles.info), _b)), (active && (_c = {
