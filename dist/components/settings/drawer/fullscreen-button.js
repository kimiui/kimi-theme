...
export function FullScreenButton() {
    ...
    return (_jsx(Tooltip, { title: fullscreen ? 'Exit' : 'Full Screen', children: _jsx(IconButton, { onClick: onToggleFullScreen, sx: {
            ...
            }, children: _jsx(SvgColor, { src: `/assets/icons/setting/${fullscreen ? 'ic-exit-full-screen' : 'ic-full-screen'}.svg`, sx: { width: 18, height: 18 } }) }) }));
}
