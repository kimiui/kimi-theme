...
open, render, active, hasChild, disabled, slotProps, externalLink, enabledRootRedirect, ...other }, ref) => {
    ...
    return (_jsxs(StyledNavItem, { ref: ref, "aria-label": title, open: open, active: active, disabled: disabled, className: stateClasses({ open: open && !active, active, disabled }), sx: {
            ...slotProps?.sx,
