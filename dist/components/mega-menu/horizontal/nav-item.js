...
var StyledNavItem = (0, styles_1.styled)(ButtonBase_1.default, {
    ...
    return (_b = {
        ...
        _b["& .".concat(nav_section_1.navSectionClasses.item.title)] = __assign(__assign({}, theme.typography.body2), { flexShrink: 0, fontWeight: theme.typography.fontWeightMedium }),
