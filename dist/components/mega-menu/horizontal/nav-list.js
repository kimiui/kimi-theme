...
function NavList(_a) {
    var _b;
    var data = _a.data, render = _a.render, slotProps = _a.slotProps, enabledRootRedirect = _a.enabledRootRedirect, cssVars = _a.cssVars;
    ...
    if (data.children) {
        return ((0, jsx_runtime_1.jsxs)(nav_section_1.NavLi, { disabled: data.disabled, children: [renderNavItem, (0, jsx_runtime_1.jsx)(Popover_1.default, { disableScrollLock: true, open: openMenu, anchorEl: navItemRef.current, anchorOrigin: { vertical: 'bottom', horizontal: 'left' }, transformOrigin: { vertical: 'top', horizontal: 'left' }, slotProps: {
                        paper: {
                            onMouseEnter: handleOpenMenu,
                            onMouseLeave: handleCloseMenu,
                            sx: __assign(__assign(__assign({ 
                                /* Reset */
                                boxShadow: 'none', overflow: 'unset', backdropFilter: 'none', background: 'transparent' }, (multiList && {
                                right: 0,
                                mx: 'auto',
                                left: '0 !important',
                                top: "".concat(clientRect.top + clientRect.height, "px !important"),
                                maxWidth: {
                                    xs: theme.breakpoints.values.lg,
                                    xl: theme.breakpoints.values.xl,
                                },
                            })), (openMenu && { pointerEvents: 'auto' })), slotProps === null || slotProps === void 0 ? void 0 : slotProps.paper),
                        },
                    }, sx: __assign(__assign({}, cssVars), { pointerEvents: 'none' }), children: (0, jsx_runtime_1.jsx)(Paper_1.default, { sx: __assign(__assign(__assign(__assign(__assign({}, (0, styles_2.paper)({ theme: theme, dropdown: true })), { p: 2.5, borderRadius: 2 }), (singleList && { minWidth: 240 })), (multiList && {})), slotProps === null || slotProps === void 0 ? void 0 : slotProps.paper), children: (0, jsx_runtime_1.jsx)(nav_content_1.NavContent, { singleList: singleList, data: data, slotProps: slotProps }) }) })] }));
    }
