...
export function NavList({ data, render, slotProps, cssVars, enabledRootRedirect, }) {
    ...
    if (data.children) {
        return (_jsxs(NavLi, { disabled: data.disabled, children: [renderNavItem, _jsx(Popover, { disableScrollLock: true, keepMounted: multiList, open: openMenu, anchorEl: navItemRef.current, anchorReference: "anchorPosition", anchorPosition: {
