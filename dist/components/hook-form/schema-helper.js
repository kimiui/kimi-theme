...
export const schemaHelper = {
     ...
     * defaultValue === '' | <p></p>
     */
    editor: (props) => zod.string().min(8, { message: props?.message?.required_error ?? 'Editor is required!' }),
    /**
     * object
     * defaultValue === null
     */
    objectOrNull: (props) => zod
        .custom()
     ...
     * defaultValue === false
     */
    boolean: (props) => zod.coerce.boolean().refine((bool) => bool === true, {
     ...
     * defaultValue === '' || null
     */
    file: (props) => zod.custom().transform((data, ctx) => {
     ...
     * defaultValue === []
     */
    files: (props) => zod.array(zod.custom()).transform((data, ctx) => {
