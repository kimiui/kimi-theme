...
function RHFSlider(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: name, control: control, render: function (_a) {
            ...
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Slider_1.default, __assign({}, field, { valueLabelDisplay: "auto" }, other)), (!!error || helperText) && ((0, jsx_runtime_1.jsx)(FormHelperText_1.default, { error: !!error, children: error ? error === null || error === void 0 ? void 0 : error.message : helperText }))] }));
        } }));
}
