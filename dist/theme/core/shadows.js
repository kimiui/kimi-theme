...
function createShadows(colorChannel) {
    var color1 = (0, styles_1.varAlpha)(colorChannel, 0.2);
    var color2 = (0, styles_1.varAlpha)(colorChannel, 0.14);
    var color3 = (0, styles_1.varAlpha)(colorChannel, 0.12);
    return [
        'none',
...
exports.shadows = {
    light: createShadows(palette_1.grey['500Channel']),
    dark: createShadows(palette_1.common.blackChannel),
};
