...
export declare const switches: {
    MuiSwitch: {
        ...
        styleOverrides?: Partial<import("@mui/material/styles/overrides").OverridesStyleRules<keyof import("@mui/material/Switch").SwitchClasses, "MuiSwitch", Theme>> | undefined;
        variants?: {
