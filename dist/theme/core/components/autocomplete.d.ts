...
export declare const autocomplete: {
    MuiAutocomplete: {
        ...
        styleOverrides?: Partial<import("@mui/material/styles/overrides").OverridesStyleRules<keyof import("@mui/material/Autocomplete").AutocompleteClasses, "MuiAutocomplete", Theme>> | undefined;
        variants?: {
